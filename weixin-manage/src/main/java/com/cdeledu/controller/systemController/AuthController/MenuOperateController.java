...
public class MenuOperateController {
	...
	@ResponseBody
	public AjaxJson createMenu(HttpServletRequest request, HttpServletResponse response, AuthBean authBean) {
	...
	@ResponseBody
	public AjaxJson saveMenu(HttpServletRequest request, HttpServletResponse response, AuthBean authBean) {
		AjaxJson ajaxJson = new AjaxJson();
		return ajaxJson;
	}
	...
	@ResponseBody
	public AjaxJson delMenu(HttpServletRequest request, HttpServletResponse response, AuthBean authBean) {
		AjaxJson ajaxJson = new AjaxJson();
		message = "权限: " + authBean.getAuthName() + "被删除成功";
