package com.cdeledu.payment.mch;
...
import com.cdeledu.http.wechat.XmlResult;
import com.cdeledu.type.RedpacketSendType;
import com.cdeledu.type.RedpacketStatus;
import com.cdeledu.type.RedpacketType;
import com.cdeledu.util.WeixinDateUtil;

/**
 * @ClassName: RedpacketRecord
 * @Description: 红包记录
 * @author: 独泪了无痕
 * @date: 2015-10-12 下午11:39:57
 * @version: V1.0
 */
@XmlRootElement
...
public class RedpacketRecord extends XmlResult {
	...
	public Date getFormatSendTime() {
		return sendTime != null ? WeixinDateUtil.parse2yyyyMMddHHmmss(sendTime)
				: null;
	}
	...
	public Date getFormatRefundTime() {
		return refundTime != null ? WeixinDateUtil
				.parse2yyyyMMddHHmmss(refundTime) : null;
	}
	...
	public static class RedpacketReceiver implements Serializable {
		...
		public Date getFormatReceiveTime() {
			return receiveTime != null ? WeixinDateUtil
