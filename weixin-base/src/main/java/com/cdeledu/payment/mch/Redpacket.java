...
public class Redpacket implements Serializable {
	...
	public Redpacket(String outTradeNo, String nickName, String sendName,
		...
		this.openid = openid;
		this.totalAmount = WeixinDateUtil.formaFee2Fen(totalAmount);
	}
	...
	public void setMinValue(double minValue) {
		this.minValue = WeixinDateUtil.formaFee2Fen(minValue);
	}
	...
	public void setMaxValue(double maxValue) {
		this.maxValue = WeixinDateUtil.formaFee2Fen(maxValue);
	}
